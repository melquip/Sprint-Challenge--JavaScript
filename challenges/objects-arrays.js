...
const uni = graduates.reduce((unis, graduate) => (graduate.university.includes('Uni') ? [...unis, graduate.university] : unis), []);
console.log(uni);
...
*/
const populationTotal = zooAnimals.reduce((population, animal) => population + animal.population, 0);
